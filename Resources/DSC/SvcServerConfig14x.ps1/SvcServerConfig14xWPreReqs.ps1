...
Configuration SvcServerConfig14xWPreReqs
 {
...
#>
 ...
 #ServiceBus Configuration specific settings
    ...
    $WindowsFeatures = "FileAndStorage-Services","File-Services","FS-FileServer","Storage-Services","Web-Server","Web-WebServer","Web-Common-Http","Web-Default-Doc", `
                       ...
                       "Web-ISAPI-Ext","Web-ISAPI-Filter","Web-Ftp-Server","Web-Mgmt-Tools","Web-Mgmt-Console","Web-Mgmt-Compat","Web-Metabase","NET-Framework-Features", `
                       "NET-Framework-Core","NET-Framework-45-Features","NET-Framework-45-Core","NET-Framework-45-ASPNET","NET-WCF-Services45","NET-WCF-HTTP-Activation45", `
