    ...
    #"NET-Framework-Features", "NET-Framework-Core"
      ...
      WindowsFeature NETFrameworkCore
		...
		$WindowsFeatures = "Application-Server", "AS-NET-Framework", "AS-Ent-Services", "AS-Dist-Transaction", "AS-WS-Atomic", "AS-Incoming-Trans", "AS-Outgoing-Trans", "AS-TCP-Port-Sharing", "AS-Web-Support", `
				            ...
				            "NET-Framework-45-Features", "NET-Framework-45-Core", "NET-Framework-45-ASPNET", "NET-WCF-Services45", "NET-WCF-HTTP-Activation45", "NET-WCF-MSMQ-Activation45", `
...
$SourcePath=''
$SWPath=''
BREServerConfig14xWPreReqs -output C:\dsc\ -Swpath $SWPath -SourcePath $SourcePath -configurationdata $cd
