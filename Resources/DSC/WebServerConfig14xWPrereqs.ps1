    ...
    Script SetAppPoolSetting
     {
      ...
      DependsOn="[WindowsFeature]IISWindowsFeature"
        ...
        Package AspNetMVC3
        {
            ...
            Path        = "\\azrdevfile01.paragon.mckesson.com\Root\AutomatedInstallSW\AspNetMVC3\AspNetMVC3Setup.exe"
        ...
        {
            Ensure      = "Present"  # You can also set Ensure to "Absent"
            Path        = "\\azrdevfile01.paragon.mckesson.com\Root\AutomatedInstallSW\SQLSysClrTypes\SQLSysClrTypes\SQLSysClrTypes.msi"
        ...
        {
            Ensure      = "Present"  # You can also set Ensure to "Absent"
            Path        = "\\azrdevfile01.paragon.mckesson.com\Root\AutomatedInstallSW\ReportViewer2012\ReportViewer2012\ReportViewer2012.msi"
        ...
        {
            Ensure      = "Present"  # You can also set Ensure to "Absent"
            Path        = "\\azrdevfile01.paragon.mckesson.com\Root\AutomatedInstallSW\SQLNativeClient_2008R2\SQLNativeClient_2008R2\sqlncli2008r2.msi"
